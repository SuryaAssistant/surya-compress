...
void setup() {
  ...
  // Test compressCommand and decompressCommand
  String inputCommand = "5|0|3.65|5|3.65|0.1|8|1";
  String encodedCommand;
  compressCommand(inputCommand, encodedCommand);
  Serial.print("Input Command: ");
  Serial.println(inputCommand);
  Serial.print("Compressed Command: ");
  Serial.println(encodedCommand);
  
  String decodedCommand;
  decompressCommand(encodedCommand, decodedCommand);
  Serial.print("Decompressed Command: ");
  Serial.println(decodedCommand);
  Serial.println();

  // Test compressLog and decompressLog
  String inputLog = "8|1|0|3.65|3.456|35.23|5467|999";
  String encodedLog;
  compressLog(inputLog, encodedLog);
  Serial.print("Input Log: ");
  Serial.println(inputLog);
  Serial.print("Compressed Log: ");
  Serial.println(encodedLog);

  String decodedLog;
  decompressLog(encodedLog, decodedLog);
  Serial.print("Decompressed Log: ");
  Serial.println(decodedLog);
}
